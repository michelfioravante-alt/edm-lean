...
export default function Modal({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-sm animate-in fade-in duration-150 overflow-y-auto">
            <div
                className="fixed inset-0 -z-10"
                onClick={onClose}
            />

            <div className={`relative bg-slate-950 border border-slate-800 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.9)] w-full ${maxWidth} flex flex-col h-auto max-h-[82vh] shrink-0 overflow-hidden`}>
                {title && (
