...
import { LayoutDashboard, ListTodo, Settings, ChevronLeft, Package, History, LogOut, Briefcase } from 'lucide-react';
        ...
        <>
            ...
            >
                ...
                <div className="p-4 pb-6 border-t border-slate-800 mt-auto bg-slate-950/50 safe-area-bottom">
                    ...
                    <p className="text-xs text-center text-slate-600 mt-4 uppercase tracking-[0.2em] font-bold flex flex-col items-center gap-2">
